variable "app_name" {
  ...
  type = "string"
  default = "testingtesting-dev-1522"
}

variable "custom_domain" {
  description = "Custom domain name (optional)"
  type = "string"
  default = "testingtesting-dev-1522.botics.co"
}
...
variable "repo_url" {
    ...
    type = "string"
    default = "https://github.com/crowdbotics-apps/testingtesting-dev-1522/archive/master.tar.gz"
}
